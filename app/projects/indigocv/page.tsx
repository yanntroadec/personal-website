...
/**
 * IndigoCV Project Detail Page
 */
export default function IndigoCVProject() {
  return (
      ...
      <div className="flex-1 flex flex-col px-6 py-12 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-slate-400 font-mono max-w-3xl mx-auto leading-relaxed">
            A free, trilingual CV builder supporting English, French, and Spanish.
            Fill out a guided form, preview your CV in real time, and download it as a PDF instantly.
          </p>
          {/* Live site link */}
          <a
            href="https://indigocv.com/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 mt-6 text-cyan-400 hover:text-cyan-300 font-mono transition-colors duration-300"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-7xl bg-slate-800/30 backdrop-blur-sm border-2 border-cyan-400 rounded-2xl p-8 shadow-lg shadow-cyan-400/20">
            <GitHubRepoPreview repoUrl="https://github.com/yanntroadec/Indigocv" />
          </div>
        </div>
      </div>
