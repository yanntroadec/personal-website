        ...
        <div className="flex items-center gap-3 md:gap-4 pt-4">
          ...
          {githubUrl && (
            <a
              ...
              className="px-4 py-3 md:px-6 md:py-3 bg-slate-700 hover:bg-slate-600 text-white font-bold font-mono rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-slate-600/50 flex items-center gap-2"
